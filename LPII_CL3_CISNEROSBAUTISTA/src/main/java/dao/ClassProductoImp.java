...
public class ClassProductoImp  implements IProducto{
	...
	public void ActualizarProducto(TblProductocl3 producto) {
		EntityManagerFactory em=Persistence.createEntityManagerFactory("LPII_CL3_CISNEROSBAUTISTA");
	...
	public TblProductocl3 BuscarProducto(TblProductocl3 producto) {
		EntityManagerFactory fabr=Persistence.createEntityManagerFactory("LPII_CL3_CISNEROSBAUTISTA");
